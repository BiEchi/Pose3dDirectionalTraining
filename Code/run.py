...
for subject in dataset.subjects():
    for action in dataset[subject].keys():
        if is_directional(action, args.choice):
            ...
            #                       [-0.4885563, -0.18753897, 0.5356381],
            #                       ...,
            #                       [-0.4986082, -0.16553046, 1.4991403],
            #                       [-0.77033865, -0.15552492, 1.4200939],
            #                       [-1.0088255, -0.22468951, 1.4193323]],
            #
            #                      [[-0.338374, -0.190733, 0.98480797],
            #                       [-0.47560042, -0.18039802, 0.99734],
            #                       [-0.48853844, -0.18775763, 0.53563946],
            #                       ...,
            #                       [-0.49862078, -0.16604853, 1.4990795],
            #                       [-0.7703453, -0.15599483, 1.4200186],
            #                       [-1.0088419, -0.22512649, 1.4193561]],
            #
            #                      [[-0.33832902, -0.19127099, 0.98476],
            #                       [-0.47554943, -0.18088546, 0.9973158],
            #                       [-0.4884886, -0.187995, 0.53561133],
            #                       ...,
            #                       [-0.49861407, -0.16660994, 1.4990444],
            #                       [-0.7702932, -0.15644144, 1.4198422],
            #                       [-1.0087899, -0.22557378, 1.4192883]],
            #
            #                      ...,
            #
            #                      [[0.156147, -0.891028, 0.97665805],
            #                       [0.14922622, -1.0287592, 0.9854418],
            #                       [0.16165493, -1.0346155, 0.52370566],
            #                       ...,
            #                       [0.17054404, -1.0742553, 1.4190587],
            #                       [0.16973522, -1.2369927, 1.1873221],
            #                       [0.3413559, -1.076308, 1.1074029]],
            #
            #                      [[0.16265601, -0.888578, 0.97624105],
            #                       [0.1571657, -1.0264045, 0.98452616],
            #                       [0.16625917, -1.0330437, 0.52272296],
            #                       ...,
            #                       [0.18084677, -1.0715998, 1.4177394],
            #                       [0.18388349, -1.2341328, 1.1858779],
            #                       [0.35141504, -1.0692812, 1.1057692]],
            #
            #                      [[0.16871001, -0.885719, 0.975682],
            #                       [0.16438632, -1.0236042, 0.98367876],
            #                       [0.17085303, -1.0314438, 0.5218501],
            #                       ...,
            #                       [0.19052584, -1.0685309, 1.4166545],
            #                       [0.19683826, -1.2300416, 1.1841457],
            #                       [0.36108732, -1.0621533, 1.1035477]]], dtype=float32),
            #                       'cameras': [
            #     {'orientation': array([0.15232472, -0.1544232, -0.75475633, 0.619107], dtype=float32),
            #      'translation': array([2.0984402, 4.9265547, 1.5002786], dtype=float32), 'id': '54138969',
            ...
            #      'tangential_distortion': array([-0.0009757, -0.00142447], dtype=float32), 'res_w': 1000, 'res_h': 1002,
            ...
            #     {'orientation': array([0.61894494, -0.7600917, -0.15300633, 0.12552583], dtype=float32),
            #      'translation': array([2.0831823, -4.912173, 1.5610787], dtype=float32), 'id': '55011271',
            #      'center': array([0.01769722, 0.01612985], dtype=float32),
            #      'focal_length': array([2.2993512, 2.2951834], dtype=float32),
            #      'radial_distortion': array([-0.19421363, 0.24040854, 0.00681998], dtype=float32),
            #      'tangential_distortion': array([-0.00161903, -0.00274089], dtype=float32), 'res_w': 1000,
            #      'res_h': 1000, 'azimuth': array(-70., dtype=float32),
            #      'intrinsic': array([2.2993512e+00, 2.2951834e+00, 1.7697215e-02, 1.6129851e-02,
            #                          -1.9421363e-01, 2.4040854e-01, 6.8199756e-03, -1.6190266e-03,
            #                          -2.7408944e-03], dtype=float32)},
            #     {'orientation': array([0.14943229, -0.15650228, 0.7681234, -0.60263044], dtype=float32),
            #      'translation': array([-1.6098154, 5.1773357, 1.5378968], dtype=float32), 'id': '58860488',
            #      'center': array([0.03963172, 0.00280535], dtype=float32),
            #      'focal_length': array([2.2982814, 2.297598], dtype=float32),
            #      'radial_distortion': array([-0.20833819, 0.255488, -0.0024605], dtype=float32),
            #      'tangential_distortion': array([0.00148439, -0.00076], dtype=float32), 'res_w': 1000, 'res_h': 1000,
            #      'azimuth': array(110., dtype=float32),
            #      'intrinsic': array([2.2982814e+00, 2.2975979e+00, 3.9631724e-02, 2.8053522e-03,
            #                          -2.0833819e-01, 2.5548801e-01, -2.4604974e-03, 1.4843870e-03,
            #                          -7.5999933e-04], dtype=float32)},
            #     {'orientation': array([0.58942515, -0.7818877, 0.13991211, -0.14715362], dtype=float32),
            #      'translation': array([-1.590738, -3.854169, 1.5780176], dtype=float32), 'id': '60457274',
            #      'center': array([0.02993643, 0.00176403], dtype=float32),
            #      'focal_length': array([2.2910228, 2.289548], dtype=float32),
            #      'radial_distortion': array([-0.19838409, 0.21832368, -0.00894781], dtype=float32),
            #      'tangential_distortion': array([-0.00058721, -0.00181336], dtype=float32), 'res_w': 1000,
            #      'res_h': 1002, 'azimuth': array(-110., dtype=float32),
            #      'intrinsic': array([2.2910228e+00, 2.2895479e+00, 2.9936433e-02, 1.7640333e-03,
            #                          -1.9838409e-01, 2.1832368e-01, -8.9478074e-03, -5.8720558e-04,
            #                          -1.8133620e-03], dtype=float32)}]}
