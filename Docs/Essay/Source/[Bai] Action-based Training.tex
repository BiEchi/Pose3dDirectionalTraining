...
for better comparison. The visualized Argument part is labeled in the corresponding letter in figure \ref{fig:four graphs}.
...
\hline
1F, 15UE (a) & VideoPose3D & 67.0 & \textbf{65.8} & 68.7 & 72.5 & \textbf{74.2} & \textbf{87.2} & \textbf{65.5} & \textbf{73.1} & 85.6 & 117 & 73.6 & \textbf{70.8} & 81.1 & 63.5 & 67.3 & 75.5 \\
...
\begin{figure*}
     ...
     \begin{subfigure}[b]{0.99\textwidth}
         \centering
         \includegraphics[width=\textwidth]{MPJPE_epoch_overall.png}
     ...
     \begin{subfigure}[b]{0.99\textwidth}
         \centering
         \includegraphics[width=\textwidth]{MPJPE_epoch_zoomed.png}
